-- Migration: Add Device Groups Table (Safe Re-run)
...
DROP POLICY IF EXISTS "Users can view device groups in their household" ON device_groups;
DROP POLICY IF EXISTS "Users can create device groups in their household" ON device_groups;
DROP POLICY IF EXISTS "Users can update their own device groups" ON device_groups;
DROP POLICY IF EXISTS "Users can delete their own device groups" ON device_groups;
...
DROP TRIGGER IF EXISTS device_groups_updated_at ON device_groups;
